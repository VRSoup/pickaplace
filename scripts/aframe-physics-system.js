//It's important to use this physics script, I am really sorry I can't find the original source for this (I'll keep looking, and huge shoutout to whoever made this)
//This script is better than the normal one for aframe V1.1 because it fixes some three js errors basically just changes Invert() to Inverser() or something like that)
